...
$config['srp6'] = true;             // "false" for SHA or "true" for SRP6 depending on your emulator support
...
$config['mysqli'] = array(
    ...
    // realm ONE
        1 => array(
            ...
            'name'                  => 'Mangos Realm One',
            'hostname'              => '127.0.0.1',
            'port'                  => 3306,
            'user'                  => 'mangos',
            'pass'                  => 'mangos',
            'database'              => 'cmangos_zero_char'
        ),
    // realm TWO
        // 3 => array(
...
$config['discord'] = array(
    ...
    'webhookurl' => 'https://discord.com/api/webhooks/867685166935310346/qQLi_DcV-iS2P6SPBOklctZKBI_7x4dcKWYlRTUVxtab08qIA1XrACvqhnqFew40oOu8',
