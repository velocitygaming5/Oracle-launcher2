...
namespace Oracle_Launcher.NotificationsBarControls.Childs
{
    /// <summary>
    ...
    public partial class NotificationRow : UserControl
    {
        ...
        {
            Opacity = 0;
            await NotificationsClass.MarkNotificationAsRead(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword, pID.ToString());
