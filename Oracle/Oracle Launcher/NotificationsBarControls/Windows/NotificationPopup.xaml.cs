...
namespace Oracle_Launcher.NotificationsBarControls.Windows
{
    ...
    public partial class NotificationPopup : Window
    {
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            SystemTray.oracleLauncher.notificationsBar.NotificationPopups.Remove(this);

            RepositionNotifications();

            await NotificationsClass.MarkNotificationAsRead(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword, pNotificationID.ToString());
        ...
        public void RepositionNotifications()
        {
            ...
            foreach (NotificationPopup notification in SystemTray.oracleLauncher.notificationsBar.NotificationPopups)
            {
        ...
        {
            int pNotificationsCount = SystemTray.oracleLauncher.notificationsBar.NotificationPopups.Count;

            if (pNotificationsCount > 0)
            {
                SystemTray.oracleLauncher.notificationsBar.BellOff.Visibility = Visibility.Collapsed;
                SystemTray.oracleLauncher.notificationsBar.BellOn.Visibility = Visibility.Visible;

                SystemTray.oracleLauncher.notificationsBar.BtnNotificationsOff.Visibility = Visibility.Collapsed;
                SystemTray.oracleLauncher.notificationsBar.BtnNotificationsOn.Visibility = Visibility.Visible;

                SystemTray.oracleLauncher.notificationsBar.BtnNotificationsOn.Content = $"{pNotificationsCount} notifications";
            }
            else
            {
                SystemTray.oracleLauncher.notificationsBar.BellOff.Visibility = Visibility.Visible;
                SystemTray.oracleLauncher.notificationsBar.BellOn.Visibility = Visibility.Collapsed;

                SystemTray.oracleLauncher.notificationsBar.BtnNotificationsOff.Visibility = Visibility.Visible;
                SystemTray.oracleLauncher.notificationsBar.BtnNotificationsOn.Visibility = Visibility.Collapsed;

                SystemTray.oracleLauncher.notificationsBar.BtnNotificationsOff.Content = $"{pNotificationsCount} notifications";
            }
        }
    }
}
