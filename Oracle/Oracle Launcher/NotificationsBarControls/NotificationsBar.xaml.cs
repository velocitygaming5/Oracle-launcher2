using Oracle_Launcher.NotificationsBarControls.Windows;
...
namespace Oracle_Launcher.NotificationsBarControls
{
    /// <summary>
    ...
    public partial class NotificationsBar : UserControl
    {
        ...
        private void BtnNotifications_Click(object sender, RoutedEventArgs e)
        {
            ...
            notificationsWindow.Owner = SystemTray.oracleLauncher;
        ...
        public async void UpdateVisualNotificationsCount()
        {
            ...
            {
                ExceptionHandler.AskToReport(ex, "NotificationBar.xaml.cs", "UpdateVisualNotificationsCount");
            }
        }
    }
}
