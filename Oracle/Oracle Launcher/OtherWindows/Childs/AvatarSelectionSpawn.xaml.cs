...
namespace Oracle_Launcher.OtherWindows.Childs
{
    /// <summary>
    ...
    public partial class AvatarSelectionSpawn : UserControl
    {
        ...
        {
            if (!pIsDBAvatar)
                ToolHandler.SetImageSource(imgAvatar, $"/Oracle Launcher;component/{pAvatarPath}", UriKind.Relative);
            else
        ...
        private void imgAvatar_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            ...
            pAvatarSelector.pAvatarPath = pIsDBAvatar ? pAvatarPath : $"/Oracle Launcher;component/{pAvatarPath}";
