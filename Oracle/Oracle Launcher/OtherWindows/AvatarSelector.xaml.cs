...
using Oracle_Launcher.OtherWindows.Childs;
using System;
...
namespace Oracle_Launcher.OtherWindows
{
    /// <summary>
    ...
    public partial class AvatarSelector : Window
    {
        ...
        private async void Window_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var dbAvatarsCollection = AuthClass.DBAvatarsList.FromJson(await AuthClass.GetDBAvatarsListJson(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword));
