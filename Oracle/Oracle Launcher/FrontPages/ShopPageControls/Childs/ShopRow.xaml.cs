using Oracle_Launcher.FrontPages.ShopPageControls.Windows;
using Oracle_Launcher.Oracle;
using System;
using System.Windows;
using System.Windows.Controls;

namespace Oracle_Launcher.FrontPages.ShopPageControls.Childs
{
    /// <summary>
    ...
    public partial class ShopRow : UserControl
    {
        ...
        private void BtnBuyNow_Click(object sender, RoutedEventArgs e)
        {
            ...
            buyPopup.Owner = SystemTray.oracleLauncher;
            buyPopup.ShowDialog();
        }
    }
}
