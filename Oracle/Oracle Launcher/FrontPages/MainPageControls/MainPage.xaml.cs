...
namespace Oracle_Launcher.FrontPages.MainPageControls
{
    /// <summary>
    ...
    public partial class MainPage : UserControl
    {
        ...
        public void SetExpansionBackground(int _expansionID)
        {
            ...
            {
                case 1: // vanilla
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_classic.png", UriKind.Relative);
                    break;
                case 2: // tbc
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_tbc.png", UriKind.Relative);
                    break;
                case 3: // wotlk
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_wotlk.png", UriKind.Relative);
                    break;
                case 4: // cata
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_cata.png", UriKind.Relative);
                    break;
                case 5: // mop
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_mop.png", UriKind.Relative);
                    break;
                case 6: // wod
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_wod.png", UriKind.Relative);
                    break;
                case 7: // legion
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_legion.png", UriKind.Relative);
                    break;
                case 8: // bfa
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_bfa.png", UriKind.Relative);
                    break;
                case 9: // shadowlands
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_shadowlands.png", UriKind.Relative);
                    break;
                default:
                    ToolHandler.SetImageSource(ExpansionBackground, "/Oracle Launcher;component/Assets/Expansion Backgrounds/expansion_bg_classic.png", UriKind.Relative);
                    break;
        ...
        {
            SystemTray.oracleLauncher.shopPage.LoadShopPage();
        }

        private void BtnVote_Click(object sender, RoutedEventArgs e)
        {
            SystemTray.oracleLauncher.votePage.LoadVotePage();
        }

        private void BtnTopPvP_Click(object sender, RoutedEventArgs e)
        {
            SystemTray.oracleLauncher.pvpPage.LoadPvPPage();
        }
