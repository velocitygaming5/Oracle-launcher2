    ...
    public partial class ExpansionMenuRealmRow : UserControl
    {
        ...
        private async void SetRealmstatusIcon()
        {
            if (await Task.Run(() => RealmHandler.GetRealmStatus(Realmlist, Port, 2500)))
                ToolHandler.SetImageSource(RealmStatusIcon, "/Oracle Launcher;component/Assets/Menu Icons/realm_up.png", UriKind.Relative);
            else
                ToolHandler.SetImageSource(RealmStatusIcon, "/Oracle Launcher;component/Assets/Menu Icons/realm_down.png", UriKind.Relative);
        }
    }
}
