    ...
    public partial class NavbarButton : UserControl
    {
                ...
                if (newsCollection != null)
                {
                    ...
                    if (mainPage.ArticlesPanel.Children.Count == 0)
                    {
                        mainPage.ArticlesPanel.Children.Add(new Label()
                        {
                            ...
                            FontFamily = new System.Windows.Media.FontFamily("/Oracle Launcher;component/Assets/Font/#Open Sans"),
                            FontSize = 14
                        });
                    }
                }
        ...
        private void SetWoWLogo()
        {
            switch (pExpansionID)
            {
                case 1: // classic
                {
                    ToolHandler.SetImageSource(mainPage.WoWLogo, "/Oracle Launcher;component/Assets/Logos/wow_classic_logo.png", UriKind.Relative);
                    break;
                }
                case 2: // tbc
                {
                    ToolHandler.SetImageSource(mainPage.WoWLogo, "/Oracle Launcher;component/Assets/Logos/wow_tbc_logo.png", UriKind.Relative);
                    break;
                }
                case 3: // wotlk
                {
                    ToolHandler.SetImageSource(mainPage.WoWLogo, "/Oracle Launcher;component/Assets/Logos/wow_wotlk_logo.png", UriKind.Relative);
                    break;
                }
                case 4: // cata
                {
                    ToolHandler.SetImageSource(mainPage.WoWLogo, "/Oracle Launcher;component/Assets/Logos/wow_cata_logo.png", UriKind.Relative);
                    break;
                }
                case 5: // mop
                {
                    ToolHandler.SetImageSource(mainPage.WoWLogo, "/Oracle Launcher;component/Assets/Logos/wow_mop_logo.png", UriKind.Relative);
                    break;
                }
                case 6: // wod
                {
                    ToolHandler.SetImageSource(mainPage.WoWLogo, "/Oracle Launcher;component/Assets/Logos/wow_wod_logo.png", UriKind.Relative);
                    break;
                }
                case 7: // legion
                {
                    ToolHandler.SetImageSource(mainPage.WoWLogo, "/Oracle Launcher;component/Assets/Logos/wow_legion_logo.png", UriKind.Relative);
                    break;
                }
                case 8: // bfa
                {
                    ToolHandler.SetImageSource(mainPage.WoWLogo, "/Oracle Launcher;component/Assets/Logos/wow_bfa_logo.png", UriKind.Relative);
                    break;
                }
                case 9: // shadowlands
                {
                    ToolHandler.SetImageSource(mainPage.WoWLogo, "/Oracle Launcher;component/Assets/Logos/wow_sl_logo.png", UriKind.Relative);
                    break;
                }
                default:
                    break;
