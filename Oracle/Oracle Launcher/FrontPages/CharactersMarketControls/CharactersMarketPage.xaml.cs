    ...
    public partial class CharactersMarketPage : UserControl
    {
        ...
        public async void LoadMarketPage()
        {
            ...
            try
            {
                ...
                var marketList = CharactersMarketClass.CharactersMarketList.FromJson(await CharactersMarketClass.GetCharactersMarketListJson(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword));
