using Oracle_Launcher.FrontPages.TopPvPPageControls.Childs;
...
namespace Oracle_Launcher.FrontPages.TopPvPPageControls
{
    /// <summary>
    ...
    public partial class TopPvPPage : UserControl
    {
        ...
        public async void LoadPvPPage()
        {
            ...
            {
                // realms
                var realmsCollection = GameMasterClass.RealmsList.FromJson(await GameMasterClass.GetRealmsListJson(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword));
            ...
            {
                ExceptionHandler.AskToReport(ex, "TopPvPPage.xaml.cs", "LoadPvPPage");
            }
