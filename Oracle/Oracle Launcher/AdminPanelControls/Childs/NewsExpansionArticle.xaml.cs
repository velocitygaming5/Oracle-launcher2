using Oracle_Launcher.AdminPanelControls.Pages;
        ...
        private async void BtnArticleEdit_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (editor.ShowDialog() == true)
                {
                    ...
                    var json = NewsClass.ArticleEdit.FromJson(await NewsClass.GetArticleEditResponseJson(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword, pNewsManager.pAdminPanel.SecKey,
            ...
            {
                ExceptionHandler.AskToReport(ex, "NewsExpansionArticle.xaml.cs", "BtnArticleEdit_Click");
            }
        }
        ...
        private async void BtnArticleDelete_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (confirmation.ShowDialog() == true)
                {
                    ...
                    var json = NewsClass.ArticleDelete.FromJson(await NewsClass.GetArticleDeleteResponseJson(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword, pNewsManager.pAdminPanel.SecKey,
            ...
            {
                ExceptionHandler.AskToReport(ex, "NewsExpansionArticle.xaml.cs", "BtnArticleDelete_Click");
            }
        }
    }
}
