...
namespace Oracle_Launcher.AdminPanelControls.Childs.Subchilds
{
    /// <summary>
    ...
    public partial class PageNavigator : UserControl
    {
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                ExceptionHandler.AskToReport(ex, "PageNavigator.xaml.cs", "UserControl_Loaded");
            }
        }
        ...
        public void SetSelectedPageNumber(int _pageNumber)
        {
            ...
            {
                ExceptionHandler.AskToReport(ex, "PageNavigator.xaml.cs", "SetSelectedPageNumber");
            }
        }
    }
}
