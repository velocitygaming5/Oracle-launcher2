        ...
        private async void BtnDelete_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (confirmation.ShowDialog() == true)
                {
                    ...
                    var json = NotificationsClass.NotificationDelete.FromJson(await NotificationsClass.GetNotificationDeleteResponseJson(OracleLauncher.LoginUsername,
                        OracleLauncher.LoginPassword, pAdminPanel.SecKey, pID.ToString()));
            ...
            {
                ExceptionHandler.AskToReport(ex, "NotificationRow.xaml.cs", "BtnDelete_Click");
            }
        }
    }
}
