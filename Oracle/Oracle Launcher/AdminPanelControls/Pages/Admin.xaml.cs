    ...
    public partial class Admin : UserControl
    {
        ...
        private async void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                // realms
                foreach (var realm in GameMasterClass.RealmsList.FromJson(await GameMasterClass.GetRealmsListJson(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword)))
                {
                ...
                // gm ranks
                foreach (var gmRank in GameMasterClass.GMRanksList.FromJson(await GameMasterClass.GetGMRanksListJson(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword)))
                {
            ...
            try
            {
                ...
                if (confirmation.ShowDialog() == true)
                {
                    ...
                    (
                        ...
                        (
                            OracleLauncher.LoginUsername, OracleLauncher.LoginPassword, pAdminPanel.SecKey, GMLevelAccountName.Text, cbSelectedRankId, cbSelectedRealmId, "1")
                        ).ResponseMsg
                    );
                }
            }
            ...
            try
            {
                ...
                if (confirmation.ShowDialog() == true)
                {
                    ...
                    (
                        ...
                        (
                            OracleLauncher.LoginUsername, OracleLauncher.LoginPassword, pAdminPanel.SecKey, PasswordChangeAccountName.Text, PasswordChangePassword.Password, "1")
                        ).ResponseMsg
                    );
                }
            }
            ...
            try
            {
                ...
                if (confirmation.ShowDialog() == true)
                {
                    ...
                    (
                        ...
                        (
                            OracleLauncher.LoginUsername, OracleLauncher.LoginPassword, pAdminPanel.SecKey, RawCommand.Text, cbSelectedRealmId)
                        ).ResponseMsg
                    );
                }
            }
