...
using Oracle_Launcher.AdminPanelControls.Childs.Subchilds;
...
namespace Oracle_Launcher.AdminPanelControls.Pages
{
    ...
    public partial class SoapLogs : UserControl
    {
        ...
        private async void UserControl_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                soapLogs = GameMasterClass.SoapLogs.FromJson(await GameMasterClass.GetSoapLogsJson(OracleLauncher.LoginUsername,
