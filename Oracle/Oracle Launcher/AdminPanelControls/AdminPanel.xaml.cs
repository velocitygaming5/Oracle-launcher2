...
namespace Oracle_Launcher.AdminPanelControls
{
    /// <summary>
    ...
    public partial class AdminPanel : Window
    {
        ...
        private async void BtnYes_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var secPa = AuthClass.SecPaResponse.FromJson(await AuthClass.GetSecPResponseJson(OracleLauncher.LoginUsername, OracleLauncher.LoginPassword, ToolHandler.StringToMD5(SecurityKey.Password)));
